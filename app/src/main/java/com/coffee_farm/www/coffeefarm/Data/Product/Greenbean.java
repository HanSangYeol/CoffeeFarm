...
public class Greenbean {
    ...
    public Greenbean(int id, String title, String title_Img, int price, String manufacturer, int saved_money, int distribution_cost, int asset_inventory_surplus, String grade, String country_of_origin, int count, boolean for_sale, List<String> product_picture, String product_detail_info) {
        this.id = id;
        this.title = title;
